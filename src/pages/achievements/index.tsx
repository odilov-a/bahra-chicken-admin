...
import { Col, Row, Card, Modal, notification } from "antd";
...
const Achievement = () => {
  ...
  const onDeleteHandler = (id: string) => {
    Modal.confirm({
      title: t("Вы действительно хотите удалить achievement?"),
      okText: t("да"),
      okType: "danger",
      cancelText: t("нет"),
  ...
  const deleteAction = (id: string) => {
    if (id) {
      mutate(
        { method: "delete", url: `/achievements/${id}`, data: null },
        {
          onSuccess: () => {
  ...
  return (
    <div className="flex">
      ...
      <div>
        <Container.All name="achievements" url="/achievements">
          {({ items }) => {
            return (
              <div>
                <Button
